  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (error.response && error.response.status === 401) {
        ...
        setError(
          "Erreur lors de la récupération des données météo. Veuillez vérifier le nom de la ville et réessayer."
        );
      }
    }
  };
  ...
  return (
    <>
      <div className="App">
        ...
        <footer>
          <p>&copy; Souleimane Zeggaï 2024</p>
          <a
          ...
          <a
            href="https://www.souleimane-z.com"
            target="_blank"
            rel="noopener noreferrer"
          >
            Mon Portfolio
